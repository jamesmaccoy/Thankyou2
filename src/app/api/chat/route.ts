          ...
          parts: [
            {
              ...
              Help users with their bookings and provide information about estimates based on their actual data, but il never read out the booking or estimate IDs.`,
            },
          ],
        },
        {
          ...
          parts: [
            {
              text: 'I understand. I will help users with their bookings and provide information about estimates based on their actual data. I can assist with checking booking status, viewing estimates, and answering related questions. I will never read out the booking or estimate IDs, but rather use the title, fromDate, toDate, and status to assume an action like "Update booking" or "Update estimate"',
            },
          ],
        },
      ],
